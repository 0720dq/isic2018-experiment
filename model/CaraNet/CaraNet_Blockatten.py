...
from model.CaraNet.lib.MAVit import BlockViTBlock
from typing import Type


class CaraNet_Blockatten(nn.Module):
    def __init__(self, channel=32,
        ...
        self.Blockatten0 = BlockViTBlock(
            in_channels=32,
            out_channels=64,
            downscale=True,
            num_heads=num_heads,
        ...
        self.Blockatten1 = BlockViTBlock(
                in_channels=64,
                out_channels=128,
                downscale=True,
                num_heads=num_heads,
        ...
        self.Blockatten2 = BlockViTBlock(
            in_channels=128,
            out_channels=256,
            downscale=True,
            num_heads=num_heads,
        ...
        self.Blockatten3 = BlockViTBlock(
            in_channels=256,
            out_channels=512,
            downscale=True,
            num_heads=num_heads,
    ...
    def forward(self, x):
        ...
        x1 = self.Blockatten0(x)  # bs, 64, 128, 128
        x2 = self.Blockatten1(x1)  # bs, 128, 64, 64
        x3 = self.Blockatten2(x2)  # bs, 256, 32, 32
        x4 = self.Blockatten3(x3)  # bs, 512, 16, 16
