...
from model.CaraNet.lib.MAVit import GridViTBlock
from typing import Type


class CaraNet_Gridatten(nn.Module):
    ...
    def forward(self, x):
        ...
        x1 = self.Gridatten0(x)  # bs, 64, 128, 128
        x2 = self.Gridatten1(x1)  # bs, 128, 64, 64
        x3 = self.Gridatten2(x2)  # bs, 256, 32, 32
        x4 = self.Gridatten3(x3)  # bs, 512, 16, 16
