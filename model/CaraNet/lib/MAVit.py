...
class MBConv(nn.Module):
    ...
    def __init__(
        ...
        self.main_path = nn.Sequential(
            ...
            DepthwiseSeparableConv(in_chs=in_channels, out_chs=out_channels, stride=2,
...
class GridViTBlock(nn.Module):
    ...
    def __init__(
        ...
        """ Constructor method """
        # Call super constructor
        super(GridViTBlock, self).__init__()
        # Init MBConv block
        self.mb_conv = MBConv(
            in_channels=in_channels,
            out_channels=out_channels,
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        """
        x1 = self.mb_conv(input)
        output = self.grid_transformer(x1)
        return output

class BlockViTBlock(nn.Module):
    """ MaxViT block composed of MBConv block, Block Attention, and Grid Attention.
    ...
    def __init__(
        ...
        """ Constructor method """
        # Call super constructor
        super(BlockViTBlock, self).__init__()
        # Init MBConv block
        self.mb_conv = MBConv(
            in_channels=in_channels,
            out_channels=out_channels,
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        """
        x1 = self.mb_conv(input)
        output = self.block_transformer(x1)
        return output
