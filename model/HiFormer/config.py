...
def get_hiformer_s_configs():
    ...
    # CNN Configs
    cfg.cnn_backbone = models.resnet34
    cfg.cnn_pyramid_fm = [64, 128, 256]
    cfg.resnet_weights = models.ResNet34_Weights.DEFAULT
...
def get_hiformer_b_configs():
    ...
    # CNN Configs
    cfg.cnn_backbone = models.resnet50
    cfg.cnn_pyramid_fm = [256, 512, 1024]
    cfg.resnet_weights = models.ResNet50_Weights.DEFAULT
