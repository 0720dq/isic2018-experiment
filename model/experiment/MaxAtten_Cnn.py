...
class BRAtten_Cnn(nn.Module):
    def __init__(self,
        ...
        self.BRA1 = BiLevelRoutingAttention(dim=channel[1], n_win=16)
        self.BRA2 = BiLevelRoutingAttention(dim=channel[2], n_win=16)
        self.BRA3 = BiLevelRoutingAttention(dim=channel[3], n_win=16)
        self.BRA4 = BiLevelRoutingAttention(dim=channel[4], n_win=16)
