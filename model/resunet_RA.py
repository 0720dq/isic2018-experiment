...
class Resnet34Unet_RA(nn.Module):
    ...
    def forward(self, x):
        ...
        # x2_rfb = self.rfb2_1(decode_block0)  # [b, 32, 512, 512]
        # x3_rfb = self.rfb3_1(decode_block1)  # [b, 32, 256, 256]
        # x4_rfb = self.rfb4_1(decode_block2)  # [b, 32, 128, 128]
