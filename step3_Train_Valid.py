...
train_lr_loss_path = './csv/train_valid_data_isic2018/train/AggAtten_CFP_loss.csv'
valid_loss_path = './csv/train_valid_data_isic2018/valid/loss/AggAtten_CFP_loss.csv'
valid_metric_path = './csv/train_valid_data_isic2018/valid/metric/AggAtten_CFP_metric.csv'
...
lr = 0.0001
test_epoch = 1
weight_path = r'./weight2018/AggAtten_CFP_2018.pth'
...
# from model.experiment.BRAtten_Cnn import BRAtten_Cnn
# from model.experiment.VitBRA_Cnn import VitBRA_Cnn
# from model.experiment.lib.TransNeXt import transnext_tiny
# from model.experiment.MSHNet import MSHNet
# from model.experiment.MaxAtten_TokMlp import MaxAtten_TokMlp
# from model.experiment.AggAtten_TokMlp_CFP import AggAtten_TokMlp_CFP
# from model.experiment.AggAttenFormer_CFP import AggAttenFormer_CFP
from model.experiment.MaxAtten_CFP import MaxAtten_CFP
