...
train_lr_loss_path = './csv/train_valid_data_isic2018/train/Vit_Cnn_RA_loss.csv'
valid_loss_path = './csv/train_valid_data_isic2018/valid/loss/Vit_Cnn_RA_loss.csv'
valid_metric_path = './csv/train_valid_data_isic2018/valid/metric/Vit_Cnn_RA_metric.csv'
...
lr = 0.0001
test_epoch = 1
weight_path = r'./weight2018/Vit_Cnn_RA_2018.pth'
